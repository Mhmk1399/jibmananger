...
const Footer = () => {
  return (
    <>
      ...
      <div className="fixed bottom-0 inset-x-0 mx-4   p-3 px-6 m-0   flex items-center justify-between   bg-purple-500 shadow-3xl text-gray-400 rounded-2xl cursor-pointer">
