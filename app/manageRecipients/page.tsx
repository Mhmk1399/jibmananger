...
export default function ManageRecipients() {
  ...
  <button
    ...
    className="bg-purple-500 text-white px-4 py-2 rounded-lg hover:bg-green-600 transition-colors"
  >
    افزودن+ 
  </button>
</div>
    ...
    >
      ...
      >
        ...
        <div className="flex gap-2">
          <button
            type="submit"
            className="flex-1 bg-purple-600 text-white py-2 rounded-lg hover:bg-blue-700"
          >
            ذخیره
          </button>
          <button
            ...
            className="flex-1 bg-red-200 text-gray-800 py-2 rounded-lg hover:bg-gray-300"
          >
            انصراف
          </button>
        </div>
