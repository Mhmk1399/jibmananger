          ...
          >
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-gray-600">مبلغ: {transaction.amount.toLocaleString()} تومان</p>
                <p className="text-gray-600">تاریخ: {new Date(transaction.date).toLocaleDateString('fa-IR')}</p>
